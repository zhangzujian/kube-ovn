...
func (c *ProviderNetworkClient) CreateSync(pn *apiv1.ProviderNetwork, timeout time.Duration) *apiv1.ProviderNetwork {
	pn = c.Create(pn)
...
func (c *ProviderNetworkClient) Patch(original, modified *apiv1.ProviderNetwork, timeout time.Duration) *apiv1.ProviderNetwork {
...
func (c *ProviderNetworkClient) PatchSync(original, modified *apiv1.ProviderNetwork, requiredNodes []string, timeout time.Duration) *apiv1.ProviderNetwork {
	pn := c.Patch(original, modified, timeout)
...
func (c *ProviderNetworkClient) Delete(name string, options metav1.DeleteOptions) {
	err := c.ProviderNetworkInterface.Delete(context.TODO(), name, options)
...
func (c *ProviderNetworkClient) DeleteSync(name string, options metav1.DeleteOptions, timeout time.Duration) {
