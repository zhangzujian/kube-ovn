...
func (c *ServiceClient) CreateSync(service *corev1.Service, timeout time.Duration) *corev1.Service {
	s := c.Create(service)
...
func (c *ServiceClient) Delete(name string, options metav1.DeleteOptions) {
	err := c.ServiceInterface.Delete(context.TODO(), name, options)
...
func (c *ServiceClient) DeleteSync(name string, options metav1.DeleteOptions, timeout time.Duration) {
...
func (c *ServiceClient) WaitToBeUpdated(service *corev1.Service, timeout time.Duration) bool {
