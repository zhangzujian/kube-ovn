...
const (
	...
	subnetProvider = "lb-svc-attachment.kube-system"
)
...
var _ = framework.Describe("[group:lb-svc]", func() {
	...
	ginkgo.AfterEach(func() {
		...
		serviceClient.DeleteSync(serviceName, metav1.DeleteOptions{}, timeout)
	...
	framework.ConformanceIt("should allocate dynamic external IP for service", func() {
		...
		_ = serviceClient.CreateSync(service, timeout)
