...
.PHONY: kind-init-bgp
kind-init-bgp: kind-clean-bgp kind-init-single
	...
	docker run --rm --privileged \
		...
		--pid=host \
		-v /root/clab-bgp.yaml:/clab.yaml \
