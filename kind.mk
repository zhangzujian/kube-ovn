...
DOCKER_NETWORK_UNDERLAY = $(shell echo $${DOCKER_NETWORK_UNDERLAY:-kind})
UNDERLAY_NETWORK_VAR_PREFIX = DOCKER_NETWORK_$(shell echo $(DOCKER_NETWORK_UNDERLAY) | tr '[:lower:]-' '[:upper:]_')
