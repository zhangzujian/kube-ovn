...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("vpc-gateways"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kubeovn().V1().VpcGateways().Informer()}, nil
