...
iptables -t nat -D KUBE-NODE-PORT -p tcp -m set ! --match-set ovn40subnets src -m set --match-set KUBE-NODE-PORT-LOCAL-TCP dst -j MARK --set-xmark 0x80000/0x80000
iptables -t nat -D KUBE-NODE-PORT -p udp -m set ! --match-set ovn40subnets src -m set --match-set KUBE-NODE-PORT-LOCAL-UDP dst -j MARK --set-xmark 0x80000/0x80000
...
ip6tables -t nat -D KUBE-NODE-PORT -p tcp -m set ! --match-set ovn60subnets src -m set --match-set KUBE-6-NODE-PORT-LOCAL-TCP dst -j MARK --set-xmark 0x80000/0x80000
ip6tables -t nat -D KUBE-NODE-PORT -p udp -m set ! --match-set ovn60subnets src -m set --match-set KUBE-6-NODE-PORT-LOCAL-UDP dst -j MARK --set-xmark 0x80000/0x80000
