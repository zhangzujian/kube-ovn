...
iptables -t filter -D INPUT -m set --match-set ovn40services dst -m conntrack --ctstate NEW -j REJECT
...
iptables -t filter -D FORWARD -m set --match-set ovn40services dst -m conntrack --ctstate NEW -j REJECT
...
ip6tables -t filter -D INPUT -m set --match-set ovn60services dst -m conntrack --ctstate NEW -j REJECT
...
ip6tables -t filter -D FORWARD -m set --match-set ovn60services dst -m conntrack --ctstate NEW -j REJECT
